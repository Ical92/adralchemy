var World = {
	...
	init: function(options) {
		...
		World.LANDMARKS[World.TILE.HUT] = { num: 1, minRadius: 15, maxRadius: 15, scene: 'hut', label:  _('Alchemy&nbsp;Hut') };
	...
	goHome: function() {
		...
		if(World.state.alchemyhut && $SM.get('game.buildings["alchemy hut"]', true) === 0) {
			$SM.add('game.buildings["alchemy hut"]', 1);
			Engine.event('progress', 'alchemy hut');
		}
